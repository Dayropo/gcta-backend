  ...
  static handle(error, res) {
    switch (error.type) {
      case ERROR_TYPE_ENUM.TOKEN_EXPIRED:
        return new ExpiredTokenErrorResponse(error.message, error.details).send(res)
      case ERROR_TYPE_ENUM.BAD_TOKEN:
      case ERROR_TYPE_ENUM.ACCESS_TOKEN:
        return new AccessTokenErrorResponse(error.message, error.details).send(res)
      ...
      case ERROR_TYPE_ENUM.INTERNAL:
        return new InternalErrorResponse(error.message, error.details).send(res)
      ...
      case ERROR_TYPE_ENUM.DUPLICATE_DATA_ERROR:
        return new DuplicateDataResponse(error.message, error.details).send(res)
...
class InternalError extends ApiError {
  constructor(message = "An error occurred. Please try again later", errorDetails = null) {
